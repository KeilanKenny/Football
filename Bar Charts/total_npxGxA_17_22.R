...
# 17/18
npxgxa_17_18_data <- read_html("https://fbref.com/en/comps/Big5/2017-2018/stats/players/2017-2018-Big-5-European-Leagues-Stats")

player_17_18 = html_nodes(npxgxa_17_18_data, 'th.right+ .left')
player_17_18 = html_text(player_17_18)
player_17_18 <- as.factor(player_17_18)

npxgxa_17_18 = html_nodes(npxgxa_17_18_data, '.right:nth-child(24)')
npxgxa_17_18 = html_text(npxgxa_17_18)
npxgxa_17_18 <- as.numeric(npxgxa_17_18)


data_17_18 <- data.frame(Player = player_17_18,npxGxA_17_18 = npxgxa_17_18)

data <- merge(data_20_21, data_21_22, by = 'Player')
data <- merge(data_19_20,data, by = 'Player')
data <- merge(data_18_19,data, by = 'Player')
data <- merge(data_17_18,data, by = 'Player')
...
x <-barplot(as.matrix(plot_data),
            main = "TOTAL NPXG + XA FROM 2017-22.",
            xlab = "npxG + xA",
            axes = TRUE,
            horiz = TRUE,
            col = c("#F8B195", "#F67280", "#C06C84", "#6C5B7B", "#355C7D"),
            border = NA,
            legend.text = c("17/18","18/19", "19/20", "20/21", "21/22"),
